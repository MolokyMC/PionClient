...
import static genshin.pion.Pion.utils.RenderUtil.drawRoundedRect;
...
//    }
    ...
    public static void drawBlockESP(BlockPos pos, float red, float green, float blue) {
        ...
        GL11.glDisable(2929);
        GL11.glDisable(2896);
        double renderPosX = Helper.mc.getRenderManager().viewerPosX;
        double renderPosY = Helper.mc.getRenderManager().viewerPosY;
        double renderPosZ = Helper.mc.getRenderManager().viewerPosZ;
